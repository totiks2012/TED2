...
- улучщил работу контекстного меню прежнее обновление открывала новый экзэмпляр редактора, теперь открывает из контекстного меню ФМ аргументом
в новой вкладке открытого уже редактора. Теперь это работает как ид олжно!
