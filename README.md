## Updated: 05-06-2026 Програма была частична отрефакторена, сильно почищена от глюков ,остался один Undo/Redo буду его чинить но пока что публикую как есть , редактор стал сильно удобнее СКАЧИВАЕМ ВЕРСИЮ ЯДРА main_core_3_6_0, появились новые плагины, про все изменения тексст ниже
...
TED3+ является производным от проекта TIDE (Non-Profit Open Software License 3.0) и потому наследует ту же лицензию. Это некоммерческая копилефтная лицензия: код можно использовать, изменять, распространять, но нельзя зарабатывать на нём. При распространении производных работ требуется сохранять авторские и лицензионные уведомления.
