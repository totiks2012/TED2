## Updated: 05-06-2026 Програма былчастична отрефакторена, сильно почищена от глюков ,остался один Undo/Redo бу его чинить но пока что публикую как есть , редактор стал сильно удобнее СКАЧИВАЕМ ВЕРСИЮ ЯДРА main_core_3_6_0, появились новые плагины, про все изменения тексст ниже
