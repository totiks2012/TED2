## Обновление-13_05_25- Обновлено ядро редактора main-core-1_3.tcl - исправил фокус, при открытии фокус на новый файл, что принудит переключится на нужный, 
также добавил возможность открывать файлы аогументом из контекстного меню фйалового менеджера,поместите этот файл в каталог проекта, и поправьте полный путь до него 
в desktop файле, редактора.  Следующим обновлением добавль подсветку синтаксиса для языков програмирования C,C++,python,lua, также обеспечу запуск скриптовых языков
из перечисленых.
